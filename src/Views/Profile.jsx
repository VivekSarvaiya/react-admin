...
import { Card, Form, Input, Modal, Select, Upload } from "antd";
const { Option } = Select;
                                ...
                                >
                                    <div className="d-flex align-items-center flex-wrap gap-5">
                                        <div>
                                            ...
                                            {editmode && (
                                                <Button variant="outlined" component="label" className="m-4">
                                    ...
                                    {editmode && (
                                        <>
                                            ...
                                            <Button type="button" variant="contained" Click={() => setEditmode(false)}>
                                                Cancel
                                            </Button>
                                        </>
                                    )}
